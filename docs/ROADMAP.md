...
- [x] Dois slots de armamento e arma rastreada pela mão direita no VR.
- [x] Perfil inicial de desempenho Quest com foveação, escala de framebuffer e efeitos reduzidos.
